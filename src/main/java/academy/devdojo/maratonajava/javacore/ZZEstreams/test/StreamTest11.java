...
public class StreamTest11 {
  ...
  public static void main(String[] args) {
    ...
    lightNovels.stream().max(Comparator.comparing(lightNovel -> lightNovel.getPrice())).ifPresent(System.out::println);
    lightNovels.stream().collect(Collectors.maxBy(Comparator.comparing(lightNovel -> lightNovel.getPrice()))).ifPresent(System.out::println);
